              ...
              <div className="relative border border-[#DDD9D3] dark:border-slate-700 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl p-6 sm:p-8 lg:p-10 shadow-[0_24px_80px_rgba(28,28,28,0.08)]">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex items-center gap-4 mt-5">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#8A8A8A] dark:text-slate-400">
                      O
                    </span>
                    <span className="flex-1 h-px bg-[#E6E1DA]" />
                  </div>
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex h-12 w-full items-center justify-center gap-3 border border-[#DDD9D3] dark:border-slate-700 bg-white px-6 text-[11px] font-black uppercase tracking-[0.22em] text-[#1C1C1C] dark:text-slate-100 transition hover:border-[#1C1C1C] hover:bg-[#F8F7F5]"
                  >
