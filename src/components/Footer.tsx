      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-16 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
          ...
          <div className="flex flex-wrap gap-x-16 gap-y-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-3">
                <Link href="/homepage" className="text-[13px] font-600 text-[#5A5A5A] hover:text-[#1C1C1C] transition-colors">
                  Soporte
                </Link>
                <Link href="/homepage" className="text-[13px] font-600 text-[#5A5A5A] hover:text-[#1C1C1C] transition-colors">
                  Envíos
        ...
        <div className="mt-12 pt-8 border-t border-[#DDD9D3] flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-[12px] font-500 text-[#8A8A8A]">
            © 2026 NovaStore. Todos los derechos reservados.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/homepage" className="text-[12px] font-500 text-[#8A8A8A] hover:text-[#1C1C1C] transition-colors">
              Privacidad
            </Link>
